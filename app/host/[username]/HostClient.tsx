...
export default function HostClient({ username }: HostClientProps) {
  ...
  useEffect(() => {
    const loadHost = async () => {
      setLoading(true);
      const profile = await getHostProfileByUsername(username);
      if (profile) {
        setHost({ name: profile.name, hostUsername: profile.hostUsername || username });
